...
//define PWM_LEFT1 2                                                  // PWM Left Wheel 1 from digital pin 2
//define PWM_LEFT2 3                                                  // PWM Left Wheel 2 from digital pin 3
      ...
      if (customCharacteristic.written()) {                                             // Check if the characteristic was written
        ...
        if (strcmp(receivedString, "F") == 0) {                                         //Forward button pressed
          ...
          if (millis()-timer_value>10) {
            ...
            PWM_A = PWM_B = PID(Tilt_Angle, wanted_angle);
          }
        }
        ...
        delay(500);                                                        // Delay for each serial monitor reading
      }
    }
  }
}

int PID (float Tilt_Angle, float wanted_angle) {
